/*****************************************************************************
 *
 * omegonprocam.h -- Touptek library header for Omegon Pro cameras
 *
...
#ifndef OA_OMEGONPROCAM_H
#define OA_OMEGONPROCAM_H
...
// Function name
#define TT_FUNC( suffix)			Omegonprocam_ ## suffix
...
#define TT_TYPE( type )				Omegonprocam ## type
